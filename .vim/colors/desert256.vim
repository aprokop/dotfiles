...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    let s:invisible = 0
    fun! <SID>change_comment_colors()
        if s:invisible
            exec "hi Comment guifg=#87ceeb ctermfg=117"
            let s:invisible = 0
        else
            exec "hi Comment guifg=#000000 ctermfg=16"
            let s:invisible = 1
        endif
    endfun
    nnoremap ,c :call <SID>change_comment_colors()<CR>
